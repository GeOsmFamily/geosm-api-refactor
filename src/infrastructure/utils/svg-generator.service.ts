...
export const ICON_CATALOG: { key: string; label: string; category: string; svgPath: string }[] = [
  ...
  { key: 'water-treatment', label: "Station de traitement d'eau", category: 'eau', svgPath: WATER_TREATMENT },
  { key: 'irrigation-canal', label: "Canal d'irrigation", category: 'eau', svgPath: IRRIGATION_CANAL },
  // Sécurité
  { key: 'fire-extinguisher', label: 'Extincteur', category: 'securite', svgPath: FIRE_EXTINGUISHER },
  ...
  { key: 'athletics-track', label: 'Piste d\'athlétisme', category: 'sport', svgPath: ATHLETICS_TRACK },
  ...
  { key: 'satellite-dish', label: 'Antenne parabolique', category: 'technologie', svgPath: SATELLITE_DISH },
  ...
  // Immobilier
  { key: 'apartment-building', label: "Immeuble d'habitation", category: 'immobilier', svgPath: APARTMENT_BUILDING },
  { key: 'construction-crane', label: 'Chantier de construction', category: 'immobilier', svgPath: CONSTRUCTION_CRANE },
  { key: 'land-plot', label: 'Parcelle', category: 'immobilier', svgPath: LAND_PLOT },
  { key: 'real-estate-sign', label: 'Agence immobilière', category: 'immobilier', svgPath: REAL_ESTATE_SIGN },
  { key: 'skyscraper', label: 'Tour/Gratte-ciel', category: 'immobilier', svgPath: SKYSCRAPER },
  { key: 'house-for-sale', label: 'Bien à vendre', category: 'immobilier', svgPath: HOUSE_FOR_SALE },
  { key: 'gate', label: 'Portail', category: 'immobilier', svgPath: GATE },
  { key: 'fence', label: 'Clôture', category: 'immobilier', svgPath: FENCE },
  // Industrie
  { key: 'crane-industrial', label: 'Grue industrielle', category: 'industrie', svgPath: CRANE_INDUSTRIAL },
  ...
  { key: 'silo-industrial', label: 'Silo industriel', category: 'industrie', svgPath: SILO_INDUSTRIAL },
  ...
  { key: 'refugee-tent', label: 'Camp de réfugiés', category: 'humanitaire', svgPath: REFUGEE_TENT },
  { key: 'red-cross-tent', label: 'Tente médicale d\'urgence', category: 'humanitaire', svgPath: RED_CROSS_TENT },
  { key: 'water-truck', label: "Camion-citerne d'eau", category: 'humanitaire', svgPath: WATER_TRUCK },
  { key: 'food-distribution', label: 'Distribution alimentaire', category: 'humanitaire', svgPath: FOOD_DISTRIBUTION },
  { key: 'ngo-flag', label: 'ONG', category: 'humanitaire', svgPath: NGO_FLAG },
  { key: 'first-aid-kit', label: 'Trousse de secours', category: 'humanitaire', svgPath: FIRST_AID_KIT },
  ...
  { key: 'hiking-trail', label: 'Sentier de randonnée', category: 'tourisme', svgPath: HIKING_TRAIL },
  { key: 'national-park-gate', label: 'Entrée de parc national', category: 'tourisme', svgPath: NATIONAL_PARK_GATE },
  ...
  // Services publics
  { key: 'post-office', label: 'Bureau de poste', category: 'services-publics', svgPath: POST_OFFICE },
  { key: 'voting-box', label: 'Bureau de vote', category: 'services-publics', svgPath: VOTING_BOX },
  { key: 'civil-registry', label: 'État civil', category: 'services-publics', svgPath: CIVIL_REGISTRY },
  ...
  // Télécommunications
  { key: 'cell-tower', label: 'Pylône télécom', category: 'telecommunications', svgPath: CELL_TOWER },
  { key: 'fiber-cable', label: 'Fibre optique', category: 'telecommunications', svgPath: FIBER_CABLE },
  { key: 'radio-tower', label: 'Tour radio', category: 'telecommunications', svgPath: RADIO_TOWER },
  { key: 'tv-tower', label: 'Tour de télévision', category: 'telecommunications', svgPath: TV_TOWER },
  { key: 'satellite', label: 'Satellite', category: 'telecommunications', svgPath: SATELLITE },
  { key: 'broadcast', label: 'Diffusion/Réseau', category: 'telecommunications', svgPath: BROADCAST },
  // Urbanisme
  { key: 'street-light', label: 'Éclairage public', category: 'urbanisme', svgPath: STREET_LIGHT },
  { key: 'traffic-light', label: 'Feu de circulation', category: 'urbanisme', svgPath: TRAFFIC_LIGHT },
  ...
  { key: 'pedestrian-crossing', label: 'Passage piéton', category: 'urbanisme', svgPath: PEDESTRIAN_CROSSING },
