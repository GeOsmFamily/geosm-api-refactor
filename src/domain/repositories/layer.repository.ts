...
export interface ILayerRepository {
  ...
  findByInstance(instanceId: string, options?: { page?: number; limit?: number; search?: string; geometryType?: GeometryType; subGroupId?: string }): Promise<{ data: Layer[]; total: number }>;
