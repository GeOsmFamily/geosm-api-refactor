...
import {
  ...
  CreateMapCompositionDTO,
} from '../../application/use-cases/maps/create-map-composition.use-case.js';
...
export async function mapCompositionRoutes(app: FastifyInstance): Promise<void> {
  const createUseCase = app.diContainer.resolve<CreateMapCompositionUseCase>(
    'createMapCompositionUseCase',
  );
  const getListUseCase = app.diContainer.resolve<GetMapCompositionsUseCase>(
    'getMapCompositionsUseCase',
  );
  const getOneUseCase = app.diContainer.resolve<GetMapCompositionUseCase>(
    'getMapCompositionUseCase',
  );
  const updateUseCase = app.diContainer.resolve<UpdateMapCompositionUseCase>(
    'updateMapCompositionUseCase',
  );
  const deleteUseCase = app.diContainer.resolve<DeleteMapCompositionUseCase>(
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Lister les compositions de carte',
        tags: ['Compositions de carte'],
        security: [{ bearerAuth: [] }],
      },
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Obtenir une composition de carte',
        tags: ['Compositions de carte'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate],
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Creer une composition de carte',
        tags: ['Compositions de carte'],
        security: [{ bearerAuth: [] }],
  ...
  app.put(
    ...
    {
      schema: {
        description: 'Mettre a jour une composition de carte',
        tags: ['Compositions de carte'],
        security: [{ bearerAuth: [] }],
  ...
  app.delete(
    ...
    {
      schema: {
        description: 'Supprimer une composition de carte',
        tags: ['Compositions de carte'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate],
