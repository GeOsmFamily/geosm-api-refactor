...
export async function feedbackRoutes(app: FastifyInstance): Promise<void> {
  const submitFeedbackUseCase = app.diContainer.resolve<SubmitFeedbackUseCase>('submitFeedbackUseCase');
  ...
  app.post('/', {
    schema: { description: 'Soumettre un signalement (bug, suggestion, demande de fonctionnalité)', tags: ['Feedback'], body: zodToSwagger(submitFeedbackSchema) },
