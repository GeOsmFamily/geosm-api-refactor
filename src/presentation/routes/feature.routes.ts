...
export async function featureRoutes(app: FastifyInstance): Promise<void> {
  ...
  const updateFeatureUseCase =
    app.diContainer.resolve<UpdateFeatureUseCase>('updateFeatureUseCase');
  const deleteFeatureUseCase =
    app.diContainer.resolve<DeleteFeatureUseCase>('deleteFeatureUseCase');
  ...
  app.get(
    ...
    {
      schema: {
        description: "Lister les features d'une couche",
        tags: ['Features'],
        querystring: zodToSwagger(getFeaturesQuerySchema),
      },
    },
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Ajouter une feature',
        tags: ['Features'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(addFeatureBodySchema),
      },
      preHandler: [
        app.authenticate,
  ...
  app.patch(
    ...
    {
      schema: {
        description: 'Mettre à jour une feature',
        tags: ['Features'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(updateFeatureBodySchema),
      },
      preHandler: [
        app.authenticate,
        requireRole(Role.SUPER_ADMIN, Role.ADMIN_INSTANCE, Role.EDITOR),
  ...
  app.delete(
    ...
    {
      schema: {
        description: 'Supprimer une feature',
        tags: ['Features'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [
