...
import {
  ...
  addInstanceUserSchema,
  changeInstanceUserRoleSchema,
...
export async function instanceRoutes(app: FastifyInstance): Promise<void> {
  const listInstancesUseCase =
    app.diContainer.resolve<ListInstancesUseCase>('listInstancesUseCase');
  const getInstanceUseCase = app.diContainer.resolve<GetInstanceUseCase>('getInstanceUseCase');
  const createInstanceUseCase =
    app.diContainer.resolve<CreateInstanceUseCase>('createInstanceUseCase');
  const updateInstanceUseCase =
    app.diContainer.resolve<UpdateInstanceUseCase>('updateInstanceUseCase');
  const deleteInstanceUseCase =
    app.diContainer.resolve<DeleteInstanceUseCase>('deleteInstanceUseCase');
  const getInstanceUsersUseCase =
    app.diContainer.resolve<GetInstanceUsersUseCase>('getInstanceUsersUseCase');
  const addInstanceUserUseCase =
    app.diContainer.resolve<AddInstanceUserUseCase>('addInstanceUserUseCase');
  const removeInstanceUserUseCase = app.diContainer.resolve<RemoveInstanceUserUseCase>(
    'removeInstanceUserUseCase',
  );
  const changeInstanceUserRoleUseCase = app.diContainer.resolve<ChangeInstanceUserRoleUseCase>(
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Lister les instances',
        tags: ['Instances'],
        querystring: zodToSwagger(listInstancesQuerySchema),
      },
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
      ...
      return reply.send(
        paginatedResponse(localizeEntities(result.data, lang), {
          page: query.page ?? 1,
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Obtenir une instance par slug',
        tags: ['Instances'],
        params: zodToSwagger(slugParamSchema),
      },
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
      const { slug } = parseBody(slugParamSchema, request.params);
      const instanceRepository =
        app.diContainer.resolve<PrismaInstanceRepository>('instanceRepository');
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Obtenir une instance par ID',
        tags: ['Instances'],
        security: [{ bearerAuth: [] }],
      },
  ...
  app.post(
    '/',
    {
      schema: {
        ...
        tags: ['Instances'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(createInstanceSchema),
      },
  ...
  app.patch(
    ...
    {
      schema: {
        description: 'Mettre à jour une instance',
        tags: ['Instances'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(updateInstanceSchema),
      },
  ...
  app.get(
    ...
    {
      schema: {
        description: "Lister les utilisateurs d'une instance",
        tags: ['Instances'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN, Role.ADMIN_INSTANCE)],
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Ajouter un utilisateur à une instance',
        tags: ['Instances'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(addInstanceUserSchema),
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN, Role.ADMIN_INSTANCE)],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.delete(
    ...
    {
      schema: {
        description: "Retirer un utilisateur d'une instance",
        tags: ['Instances'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN, Role.ADMIN_INSTANCE)],
  ...
  app.patch(
    '/:instanceId/users/:userId/role',
    {
      schema: {
        description: "Changer le rôle d'un utilisateur dans une instance",
        tags: ['Instances'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(changeInstanceUserRoleSchema),
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN, Role.ADMIN_INSTANCE)],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
