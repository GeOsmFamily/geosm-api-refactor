...
export async function adminRoutes(app: FastifyInstance): Promise<void> {
  ...
  const importOsmDataUseCase =
    app.diContainer.resolve<ImportOsmDataUseCase>('importOsmDataUseCase');
  const getSystemHealthUseCase =
    app.diContainer.resolve<GetSystemHealthUseCase>('getSystemHealthUseCase');
  ...
  const createInstanceTemplateUseCase = app.diContainer.resolve<CreateInstanceTemplateUseCase>(
    'createInstanceTemplateUseCase',
  );
  const manageSequenceUseCase =
    app.diContainer.resolve<ManageSequenceUseCase>('manageSequenceUseCase');
  const reindexAllLayersUseCase =
    app.diContainer.resolve<ReindexAllLayersUseCase>('reindexAllLayersUseCase');
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Obtenir le tableau de bord',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
  ...
  app.get(
    ...
    {
      schema: {
        description: "Lister les taches en file d'attente",
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.get(
    ...
    {
      schema: {
        description: "Obtenir les details d'une tache",
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Relancer une tache echouee',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Importer des donnees OSM via osm2pgsql',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(importOsmSchema),
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.post(
    '/search/reindex-layers',
    {
      schema: {
        description: 'Reindexer toutes les couches dans MeiliSearch',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Déclencher un backup Postgres immédiat',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.get(
    ...
    {
      schema: {
        description: "Obtenir l'etat de sante du systeme",
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.get(
    ...
    {
      schema: {
        description: "Lister le catalogue d'icônes disponibles",
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      return reply.send(
        successResponse(ICON_CATALOG.map(({ key, label, category }) => ({ key, label, category }))),
      );
    },
  );
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Generer des icones SVG',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(generateIconsSchema),
      },
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Obtenir la configuration de la base de donnees',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Obtenir un aperçu de la base de données (taille, tables)',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.post(
    ...
    {
      schema: {
        description: "Creer un modele d'instance",
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(createInstanceTemplateSchema),
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Lister les sequences',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Creer une sequence',
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(createSequenceSchema),
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.delete(
    '/sequences',
    {
      schema: {
        ...
        tags: ['Administration'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(deleteSequenceSchema),
      },
      preHandler: [app.authenticate, requireRole(Role.SUPER_ADMIN)],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
