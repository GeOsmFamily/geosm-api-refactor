...
export async function adressageRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.post('/adresse', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.post('/position', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.post('/points', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.post('/click', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.get('/code-usage', async (_request: FastifyRequest, reply: FastifyReply) => {
    const result = await codeUsageUseCase.execute();
    return reply.send(successResponse(result));
  });

  // POST /adressage/elastic-data
  app.post('/elastic-data', async (request: FastifyRequest, reply: FastifyReply) => {
