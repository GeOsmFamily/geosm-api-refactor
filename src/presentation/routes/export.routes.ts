...
export async function exportRoutes(app: FastifyInstance): Promise<void> {
  ...
  const createBulkExportUseCase =
    app.diContainer.resolve<CreateBulkExportUseCase>('createBulkExportUseCase');
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Creer un export',
        tags: ['Exports'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(createExportSchema),
      },
  ...
  app.post(
    ...
    {
      schema: {
        description: 'Creer un export groupe (plusieurs couches, zip)',
        tags: ['Exports'],
        security: [{ bearerAuth: [] }],
        body: zodToSwagger(createBulkExportSchema),
      },
      preHandler: [app.authenticate],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.get(
    '/',
    {
      schema: {
        ...
        tags: ['Exports'],
        security: [{ bearerAuth: [] }],
        querystring: zodToSwagger(listExportsQuerySchema),
      },
      preHandler: [app.authenticate],
    },
    async (request: FastifyRequest, reply: FastifyReply) => {
      ...
      const result = await listExportsUseCase.execute(userId, {
        page: query.page,
        limit: query.limit,
        status: query.status,
      });
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Obtenir un export par identifiant',
        tags: ['Exports'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate],
  ...
  app.get(
    ...
    {
      schema: {
        description: 'Telecharger un export',
        tags: ['Exports'],
        security: [{ bearerAuth: [] }],
      },
      preHandler: [app.authenticate],
